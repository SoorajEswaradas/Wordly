...
public class expertfinal extends AppCompatActivity {
    ...
    public void savedata()
    {
        ...
        SharedPreferences.Editor sp1e=sp1.edit();
        sp1e.putInt(userid,wordnumber2);
        sp1e.apply();
    }
    ...
    {
        SharedPreferences sp1=getSharedPreferences(SHARED_PREFS,MODE_PRIVATE);
        wordnumber2=sp1.getInt(userid,-1);
    ...
    public void updateword()
    {
      ...
      /*  bookmarkref=new Firebase("https://wordly-b22f0.firebaseio.com/beginner/"+wordnumber2+"/bookmarked");
