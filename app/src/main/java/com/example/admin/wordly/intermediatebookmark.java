...
public class intermediatebookmark extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intermediatebookmark);
...
*/
  /*  public void loaddatabookmark()
    ...
    public void updateword()
    {
        ...
        wordref = new Firebase("https://wordly-b22f0.firebaseio.com/easybookmark/" + userid + "/" + wordnumber + "/word");
        ...
        meaningref = new Firebase("https://wordly-b22f0.firebaseio.com/easybookmark/" + userid + "/" + wordnumber + "/meaning");
        ...
        example1ref = new Firebase("https://wordly-b22f0.firebaseio.com/easybookmark/" + userid + "/" + wordnumber + "/example1");
        ...
        example2ref = new Firebase("https://wordly-b22f0.firebaseio.com/easybookmark/" + userid + "/" + wordnumber + "/example2");
