...
public class extrawordsfinal extends AppCompatActivity {

    public TextView extraword;
    ...
    public static final String SHARED_PREFS="sharedpreferencesextra";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_extrawordsfinal);
        ...
        extraword=(TextView)findViewById(R.id.extraword);
    ...
    public void updateword()
    {
        ...
        Firebase wordref,meaningref;
        wordref=new Firebase("https://wordly-b22f0.firebaseio.com/extrawords/"+wordnumber3+"/word");
        wordref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                word1=dataSnapshot.getValue(String.class);
                extraword.setText(word1);
        ...
        meaningref=new Firebase("https://wordly-b22f0.firebaseio.com/extrawords/"+wordnumber3+"/meaning");
